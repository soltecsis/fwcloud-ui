...
## [2.5.1] - 2026-05-20
### Fixed
- Help panel version labels no longer show the context-menu cursor icon, and the license link now appears on its own line.
...
- TCP Flags labels not visible in dark mode.
- Expanded node persistence in trees.
...
- Enforce CA match between VPN server certificate and new client certificate.


## [2.1.2] - 2025-09-11
### Fixed
- Unnecessary duplicated API calls in firewalls and clusters edition.
- Optimized the firewalls/clusters tree load process.


### Fixed
## [2.1.1] - 2025-09-09
### Added
- Display de users's IP and name in the FWCloud lock fail tooltip.

### Fixed
- Upgraded npm packages to the latest versions.
- Validation issue in the netmask input when create a server.
- Malfunction of the cancel button in openVPN config panel-
